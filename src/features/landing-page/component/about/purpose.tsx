...
const Purpose = () => {
    return (
        <div className='mt-24 px-4 py-14 sm:px-8 md:px-16 lg:px-32'>
            {/* Subtitle */}
            <p className='text-center text-base font-medium text-[#2A1A6E] sm:text-lg md:text-xl'>
                ABOUT US
            </p>
            ...
            {/* Description */}
            <p className='mx-auto mt-6 max-w-4xl text-center text-sm font-normal leading-relaxed text-gray-700 sm:text-base md:text-lg'>

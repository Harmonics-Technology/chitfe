...
export default function BudgetSection() {
    return (
        <ChitContainer>
            <div className='mt-16 flex w-full flex-col-reverse items-center justify-center gap-10 rounded-xl bg-[#DDF9DF4D] px-6 py-10 md:mt-27 md:flex-row md:gap-20 md:px-12 md:pt-12'>
                {/* Images on the left */}
                ...
                <div className='w-full max-w-xl text-center md:w-1/2 md:text-left'>
                    ...
                    <p className='font-[poppins] text-base font-normal leading-7 sm:w-11/12'>
